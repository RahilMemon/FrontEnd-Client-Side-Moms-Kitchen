...
const AddFeedback = ({ navigation, route }) => {
  ...
  const { dishFeedbacks, message, error, loadingF } = useSelector(
  ...
  return (
    <View className="flex-1 bg-slate-50">
      <View className="bg-white h-24 pt-8 flex-row justify-between items-center px-6 shadow-md shadow-black z-50">
