    ...
    return(
      ...
      <ScrollView showsVerticalScrollIndicator={false} className="px-12 my-7">
        ...
        <View className='flex-row flex-1 space-x-2 border-[#5E72EB] border-b-2 py-2 mb-2 items-center justify-center'>
          ...
          <TextInput keyboardType="email-address"  placeholder='Please Enter Email id' className="flex-1 text-lg pl-3" value={email} onChangeText={setEmail} />
        </View>
        <View className='my-10'>
            <TouchableOpacity
            onPress={handleForgot}  
            className='bg-sky-400 rounded-lg border-blue-400 border-r-5 py-3'>
                {loadingA ? <ActivityIndicator size="small" color="white" /> : <Text className='text-center text-xl text-white font-ui-monospace font-bold'>
                    SUBMIT
                </Text>}
            </TouchableOpacity>
        </View>
