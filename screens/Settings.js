...
import { settings } from '../MockData/MockData';
    ...
    <View className="flex-1 bg-slate-50">
      ...
      >
        ...
        <View className="flex-row justify-between items-center w-full mb-4">
          {!isAuthenticated ? <TouchableOpacity onPress={() => navigation.navigate("Login")} className="bg-white w-[184px] p-3 rounded-xl shadow shadow-black mx-1">
            ...
            <TouchableOpacity onPress={() => navigation.navigate("Profile")} className="bg-white w-[184px] p-3 rounded-xl shadow shadow-black mx-1">
          ...
          <TouchableOpacity onPress={() => navigation.navigate("ChefSignup1")} className="bg-white w-[184px] p-3 rounded-xl shadow shadow-black mx-1">
            <Ionicons name="log-in-outline" color="#262525" size={25} />
