      ...
      >
        <View className="px-4">
          ...
          <View className="justify-center my-2 space-y-3 mx-1">
            ...
            /> : <TextInput
            className="w-full bg-white py-3 px-4 border border-slate-100 rounded-md shadow shadow-black text-base focus:border-[#5E72EB] text-gray-500"
            keyboardType="email-address"
            placeholder="Email address"
            value={user?.email}
            editable={false}
          />}
            <View className="flex-row items-center space-x-2 justify-between">
              {isAuthenticated && user.userType === "Chef" ? <Dropdown
                className="w-[182px] bg-white py-2 px-4 border border-slate-100 rounded-md shadow-sm shadow-black text-base focus:border-[#5E72EB]"
                data={cuisinePicker}
              ...
              /> : <TextInput
              className="w-[182px] bg-white py-3 px-4 border border-slate-100 rounded-md shadow shadow-black text-base focus:border-[#5E72EB] text-gray-500"
              keyboardType="email-address"
              placeholder="Email address"
              value={user?.name}
              onChangeText={setName}
            />}
              <Dropdown
                className="w-[182px] bg-white py-2 px-4 border border-slate-100 rounded-md shadow shadow-black text-base focus:border-[#5E72EB]"
                data={genderPicker}
                iconStyle={{ width: 20, height: 20 }}
                // search
                selectedTextStyle={{ marginLeft: 5 }}
